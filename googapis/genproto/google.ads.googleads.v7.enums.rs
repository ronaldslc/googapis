    ...
    impl LeadFormFieldUserInputType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                LeadFormFieldUserInputType::GivenName => "GIVEN_NAME",
                LeadFormFieldUserInputType::FamilyName => "FAMILY_NAME",
    ...
    impl BudgetType {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "UNKNOWN" => Some(Self::Unknown),
                "STANDARD" => Some(Self::Standard),
                "HOTEL_ADS_COMMISSION" => Some(Self::HotelAdsCommission),
    ...
    impl ResourceLimitType {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                ResourceLimitType::LeadFormAssetLinksPerCampaign => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "LEAD_FORM_ASSET_LINKS_PER_CAMPAIGN" => {
                    Some(Self::LeadFormAssetLinksPerCampaign)
                }
