    ...
    impl ConversionAdjustmentUploadError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                ConversionAdjustmentUploadError::InvalidUserIdentifierSource => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "INVALID_USER_IDENTIFIER_SOURCE" => {
                    Some(Self::InvalidUserIdentifierSource)
                }
                _ => None,
            }
        }
    ...
    impl ConversionUploadError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                ConversionUploadError::ConversionPrecedesGclid => {
                ...
                ConversionUploadError::InvalidUserIdentifierSource => {
                    "INVALID_USER_IDENTIFIER_SOURCE"
                }
            }
        }
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "CONVERSION_PRECEDES_GCLID" => Some(Self::ConversionPrecedesGclid),
                "EXPIRED_GCLID" => Some(Self::ExpiredGclid),
                "TOO_RECENT_GCLID" => Some(Self::TooRecentGclid),
                "GCLID_NOT_FOUND" => Some(Self::GclidNotFound),
